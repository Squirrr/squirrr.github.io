...
{% include video id="OliAf7QarBU" provider="youtube" width="640px" height="360px" float="left" margin="10px"%}
...
<br>
{% include video id="2td2-swUyMg" provider="youtube" width="640px" height="360px" float="right" margin="10px"%}
